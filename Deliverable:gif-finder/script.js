...
mainButton.addEventListener("click", e => {
  ...
  var searchInput = input.value //pizza
  sendApiRequest(searchInput)//pizza
})
...
function sendApiRequest(gifTopic) {
  
    fetch("https://api.giphy.com/v1/gifs/search?api_key=ALUyyEwAFUNmg2bMkh8u1bnO2tC5k9u8&q="+gifTopic+"&limit=25&offset=0&rating=G&lang=en")
    .then(function(data) {
      return data.json();
    })
    .then(function(json) {
